#ifndef RS_ENCODER_GENERAL_DESCENDING_H
#define RS_ENCODER_GENERAL_DESCENDING_H
...
class RS_ENCODER_GENERAL_DESCENDING : public RS_ENCODER_BASE {
public:
    RS_ENCODER_GENERAL_DESCENDING(int tt, int b0);
    ~RS_ENCODER_GENERAL_DESCENDING();
...
#endif // RS_ENCODER_GENERAL_DESCENDING_H
