#ifndef RS_FLIPPED_ENCODER_T32_H
#define RS_FLIPPED_ENCODER_T32_H
...
class RS_FLIPPED_ENCODER_T32 final : public RS_ENCODER_BASE {
public:
    explicit RS_FLIPPED_ENCODER_T32(int b0);
    ~RS_FLIPPED_ENCODER_T32() override;
...
#endif // RS_FLIPPED_ENCODER_T32_H
