#ifndef RS_FLIPPED_ENCODER_T2_H
#define RS_FLIPPED_ENCODER_T2_H

#include <vector>
#include <cstdint>
#include "rs_encoder_base.h"

class RS_FLIPPED_ENCODER_T2 final : public RS_ENCODER_BASE {
public:
    explicit RS_FLIPPED_ENCODER_T2(int b0);
    ~RS_FLIPPED_ENCODER_T2() override;
