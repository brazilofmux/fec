...
RS_FLIPPED_ENCODER_T1::RS_FLIPPED_ENCODER_T1(int b0)
...
RS_FLIPPED_ENCODER_T1::~RS_FLIPPED_ENCODER_T1() {
    delete[] ptable;
}

void RS_FLIPPED_ENCODER_T1::RSGenPoly() {
    // Initially, g(x) = (X+@^b0)
    gg[0] = pow2poly_[b0_];
    gg[1] = 1;
...
void RS_FLIPPED_ENCODER_T1::RSGenTable() {
...
void RS_FLIPPED_ENCODER_T1::RSEncode(GF data[MAX_KK], GF bb[2 * MAX_TT]) {
