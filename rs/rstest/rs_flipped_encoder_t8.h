#ifndef RS_FLIPPED_ENCODER_T8_H
#define RS_FLIPPED_ENCODER_T8_H
...
class RS_FLIPPED_ENCODER_T8 final : public RS_ENCODER_BASE {
public:
    explicit RS_FLIPPED_ENCODER_T8(int b0);
    ~RS_FLIPPED_ENCODER_T8() override;
...
private:
    ...
    const GF* poly2pow_;
    std::vector<GF> gg;
    static constexpr int TABLE_SIZE = 256 * 16;  // 16 bytes per feedback value for tt=8
    GF* ptable;
