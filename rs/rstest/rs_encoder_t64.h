#ifndef RS_ENCODER_T64_H
#define RS_ENCODER_T64_H

#include "rs_encoder_base.h"
#include <vector>

class RS_ENCODER_T64 final : public RS_ENCODER_BASE {
public:
    explicit RS_ENCODER_T64(int b0);
    ~RS_ENCODER_T64() override;
