#ifndef RS_FLIPPED_ENCODER_T64_H
#define RS_FLIPPED_ENCODER_T64_H
...
class RS_FLIPPED_ENCODER_T64 final : public RS_ENCODER_BASE {
public:
    explicit RS_FLIPPED_ENCODER_T64(int b0);
    ~RS_FLIPPED_ENCODER_T64() override;
...
private:
    ...
    const GF* poly2pow_;
    std::vector<GF> gg;
    static constexpr int TABLE_SIZE = 256 * 128;  // 128 bytes per feedback value for tt=64
    GF* ptable;
...
#endif // RS_FLIPPED_ENCODER_T64_H
